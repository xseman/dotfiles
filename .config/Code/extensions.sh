...
# Generated by:
# cd .config/Code
# cat extensions.sh | head -6 > /tmp/extensions.sh && code --list-extensions | xargs -L 1 echo code --install-extension >> /tmp/extensions.sh && mv /tmp/extensions.sh extensions.sh
